<h2 class="header-sections">Usuarios</h2>
...
<div class="container lista-usuarios">
    <div class="d-flex justify-content-between mb-3">
        ...
        <div>
            ...
            <a href="<?= base_url('usuarios_eliminados') ?>" class="btn btn-secondary ms-2">Eliminados</a>
        </div>
    </div>
                    ...
                    <?php if ($usuario['baja'] != 'SI'): ?>
                        <tr class="">
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('eliminar_usuario/' . $usuario['id_usuario']) ?>" class="btn btn-danger btn-sm">Borrar</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                <?php endforeach; ?>
